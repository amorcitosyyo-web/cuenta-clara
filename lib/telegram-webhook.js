...
async function analyzeTelegramImage(message, caption, imageFileIds = null) {
  ...
  try {
    ...
    const data = {
      ...
      category: category?.id || "imprevistos", note: receiptNote(receipt.items, receipt.note), receipt, receiptItems,
    };
...
module.exports._test = { findRecurringPaymentRequest, isIndependentFinancialRequest, detectRecurringCandidates, isRecurringAnalysisRequest, detectEmailIntent, findCategoryDetailRequest, summarizeCategoryMovements, summarizeCategoryMaximum, findClassificationReview, isMonthMovementsQuestion, findOperationalAction, handleMovementDraft, findDeleteRequest };
